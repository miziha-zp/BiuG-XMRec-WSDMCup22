...
if __name__ == "__main__":
    ...
    # load data
    TRAIN_PATH = join('/home/lichangyv/miziha/LightGCN-PyTorch-master/data/' + args.dataset + '/', 'train.txt')
    TEST_PATH = join('/home/lichangyv/miziha/LightGCN-PyTorch-master/data/' + args.dataset + '/', 'test.txt')
