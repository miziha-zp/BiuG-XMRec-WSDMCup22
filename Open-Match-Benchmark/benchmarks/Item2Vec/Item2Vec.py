...
from predictor import item2vec_predict 
...
if __name__ == "__main__":
    ...
    # item2vec_predict()
    testing = 'testing' in args.dataset
    item2vec_predict(model, '../../../input/{}'.format(args.dataset.split('_')[0]), dim=args.emb_dim, testing=testing)
