...
def score_for_series(sim, num, item_users, data, topK=10, prefix=''):
    ...
    data[prefix+'_itemCFscore_list'] = cnt_list
    data[prefix+'_itemCFscore_weighted_list'] = weighted_cnt_list
    return data
# 
...
def get_itemCF_score(train, train5core, lgb_valid_data, lgb_test_data, K_list=[100]):
    ...
    for K in K_list:
        print('-'*20, K, '-'*20)
        # lgb_valid_data, lgb_test_data = itemCF_score(train5core, lgb_valid_data, lgb_test_data,K, prefix='train5core@K={}'.format(K))
        ...
        lgb_valid_data, lgb_test_data = itemCF_score(train_data, lgb_valid_data, lgb_test_data, K, prefix='concat_train@K={}'.format(K))
